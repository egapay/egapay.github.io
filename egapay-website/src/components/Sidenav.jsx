...
const Sidenav = ({ onButtonClick }) => {
  return (
    <section className="w-full lg:w-1/4 h-auto lg:h-screen p-6 bg-main-primary flex flex-col justify-center mx-auto">
        ...
        <div id="buttons" className="flex lg:flex-col flex-row items-center justify-center lg:space-y-4">
          <button onClick={() => onButtonClick("About")} 
            className="btn btn-xs xs:btn-sm sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl w-1/5 lg:w-1/2 bg-main-text">About</button>
          <button onClick={() => onButtonClick("Skills")} 
            className="btn btn-xs xs:btn-sm sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl w-1/5 lg:w-1/2 bg-main-text">Skills</button>
          <button onClick={() => onButtonClick("Projects")} 
            className="btn btn-xs xs:btn-sm sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl w-1/5 lg:w-1/2 bg-main-text">Projects</button>
          <button onClick={() => onButtonClick("Contact")} 
            className="btn btn-xs xs:btn-sm sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl w-1/5 lg:w-1/2 bg-main-text">Contact</button>
        </div>
    </section>
  )
}
